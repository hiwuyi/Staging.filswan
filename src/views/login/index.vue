        ...
        <div class="loginAreaRight" v-loading="loginLoad">
          ...
          <transition name="phoneTypeFade" mode="out-in">
            ...
            <div class="form-box mail-wrapper" key="mail">
              ...
              <div class="loginFormDiv">
                <input type="password" class="form-input" :placeholder="generateLogin('login_mailpw')"
                      v-model="formData.mail.password"/>
              </div>
              <div class="form-tips" v-show="verify.mailPassword.tipsbox">{{verify.mailPassword.tips}}</div>

              <a href="javascript:void(0);" @click="menuIndexFun('/forget',7)"
                 class="login_forgetPass">{{generateLogin('login_mailforget')}}</a>
